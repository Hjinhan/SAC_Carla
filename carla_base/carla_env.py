...
class CarlaEnv(gym.Env):
    ...
    def __init__(self,config, carla_port, tm_port):
        ...
        self.render_display = config.render
        self.changing_weather_speed = float(config.changing_weather_speed)
        self.frame_skip = config.frame_skip
        self.observations_type = config.observations_type
        ...
        print(carla_port)
        self.client = carla.Client('127.0.0.1', self.carla_port)
