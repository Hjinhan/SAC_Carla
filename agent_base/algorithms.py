...
class SAC_Alg:
    def __init__(self,
        ...
        """ SAC algorithm
            Args:
                model(odel): forward network of actor and critic.
        ...
        assert isinstance(config.actor_lr, float)
        assert isinstance(config.critic_lr, float)
        ...
        self.actor_optimizer = torch.optim.Adam(
            self.model.get_actor_params(), lr=self.actor_lr)
        self.critic_optimizer = torch.optim.Adam(
            self.model.get_critic_params(), lr=self.critic_lr)
